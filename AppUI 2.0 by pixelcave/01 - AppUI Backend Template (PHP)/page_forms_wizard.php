        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
            ...
            <div class="block">
                ...
                <form id="progress-wizard" action="page_forms_wizard.php" method="post" class="form-horizontal form-bordered">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-md-8 col-md-offset-4">
                            <button type="reset" class="btn btn-effect-ripple btn-danger" id="back2">Back</button>
            ...
            <div class="block">
                ...
                <form id="validation-wizard" action="page_forms_wizard.php" method="post" class="form-horizontal form-bordered">
                    <!-- First Step -->
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <ul class="nav nav-pills nav-justified">
                                    <li class="active disabled"><a href="javascript:void(0)" class="text-muted"> <i class="fa fa-user"></i> <strong>Account</strong></a></li>
                                    <li class="disabled"><a href="javascript:void(0)"><i class="fa fa-info-circle"></i> <strong>Info</strong></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- END Step Info -->
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-validation-username">Username <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="text" id="example-validation-username" name="example-validation-username" class="form-control" placeholder="Choose a nice username.." required>
                                    <span class="input-group-addon"><i class="gi gi-user"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-validation-email">Email <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="text" id="example-validation-email" name="example-validation-email" class="form-control" placeholder="Enter your valid email.." required>
                                    <span class="input-group-addon"><i class="gi gi-envelope"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-validation-password">Password <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="password" id="example-validation-password" name="example-validation-password" class="form-control" placeholder="Choose a good one.." required>
                                    <span class="input-group-addon"><i class="gi gi-asterisk"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-validation-confirm-password">Retype Password <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="password" id="example-validation-confirm-password" name="example-validation-confirm-password" class="form-control" placeholder="..and confirm it to be safe!" required>
                                    <span class="input-group-addon"><i class="gi gi-asterisk"></i></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="validation-second" class="step">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <ul class="nav nav-pills nav-justified">
                                    <li class="disabled"><a href="javascript:void(0)" class="text-muted"><del><i class="fa fa-user"></i> <strong>Account</strong></del></a></li>
                                    <li class="active disabled"><a href="javascript:void(0)"><i class="fa fa-info-circle"></i> <strong>Info</strong></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- END Step Info -->
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea id="example-validation-suggestions" name="example-validation-suggestions" rows="5" class="form-control" placeholder="Share your ideas with us.."></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label class="switch switch-primary" for="example-validation-terms">
                                    <input type="checkbox" id="example-validation-terms" name="example-validation-terms" value="1">
                                    <span data-toggle="tooltip" title="I agree to the terms!"></span>
                                </label>
                            </div>
                        </div>
